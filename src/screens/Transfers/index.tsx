...
const recieveOptions: StackNavigationOptions = {
  ...
  headerTransparent: true,
  headerTitle: () => <LayoutHeader  light={true} title={'Receive'} titleColor={'white'} />,
  headerBackTitleVisible: false,
  headerLeft: null,
};
...
export function TransfersRoutes() {
  return (
    <Transfers.Navigator
      ...
      />
      <Transfers.Screen name="recieve" component={RecieveTransferScreen} options={recieveOptions} />
    </Transfers.Navigator>
  );
}
